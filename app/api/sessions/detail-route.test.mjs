// Static + behavior coverage for the session detail API's tail bound (the
// #509/#555 transfer fix). Source assertions confirm the route parses ?tail
// (default 50, NaN-safe, capped at 1000) and derives session-wide metadata
// (messageCount/firstMessage) from the full entries, not the sliced context.
// The data-slicing behavior itself is covered end-to-end in
