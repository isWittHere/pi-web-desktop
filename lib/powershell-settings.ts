...
/** True when the persisted default tools select PowerShell instead of Bash as the shell tool. */
...
/** Swap any shell tool name (bash/powershell) to the active shell in a tool list, deduping. */
...
/** Apply the persisted PowerShell preference to a concrete tool-name list. */
