...
/**
 * Send a JSON body, gzip-compressing it only when it is large enough and the
 * client advertises gzip support. Compressed responses add the encoding to the
 * Vary header so shared caches key on Accept-Encoding. Mirrors upstream
 * 09383ae (lib/json-response.ts).
 */
